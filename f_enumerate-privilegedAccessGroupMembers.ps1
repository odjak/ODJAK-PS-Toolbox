# - Import necessary modules - ActiveDirectory and PSHTML - - - -#
Import-Module ActiveDirectory
Import-Module PSHTML

# - Define the output paths - reportPath and hashPath - - - - - -# 
...
# - Define domains to check - replace with actual domain names -#

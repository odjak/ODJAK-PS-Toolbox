...
# - You can add more functions here to get more information about your AD environment.
Get-ADInactiveUsers{
    [CmdletBinding(SupportsShouldProcess=$true)]
    param(
        [Parameter(Mandatory=$true)]
    ...
    .DESCRIPTION
    This function will return all inactive users in a specific OU.
    .PARAMETER SearchBase
    The OU to search for inactive users.
    .EXAMPLE
    Get-ADInactiveUsers -SearchBase 'OU=My Users,DC=contoso,DC=com'
    This will return all inactive users in the 'My Users' OU.
    .NOTES
    Part of a series of functions to govern and manage life cycle of groups, users and computers in Active Directory.
    #>
